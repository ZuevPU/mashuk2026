        ...
        <div className="adm-modal-backdrop" onClick={() => setNotifyModal(null)}>
          <div className="card" style={{ maxWidth: 480, width: '100%' }} onClick={e => e.stopPropagation()}>
            ...
            <p className="adm-muted" style={{ fontSize: 13, marginTop: 0 }}>
              ...
              <br />
              Участникам уйдёт ваш текст в уведомление мини-приложения и в личку сообщества,
              плюс ссылка на этот вопрос. Если сегодня уже уходило авто-оповещение этой точки —
              лучше откройте «Уведомления → По дням», чтобы не задвоить.
            </p>
