...
/**
 * Старый детальный разбор одного направления (GET /analytics/dashboards/direction).
 * В новой линзе показывается внизу экрана.
 */
export function HubDirectionLegacy({ onOpenCard }: { onOpenCard: (id: number) => void }) {
  const {
