  ...
  return (
    <div className="adm-forum adm-levels">
      <AdminPageHero
        ...
        hint="Ставки по типам действий — базовые значения для линий «Путь» и «Опыт». Баллы конкретного вопроса и задания задаются в разделах «Вопросы» и «Задания» и могут отличаться от таблицы ниже. Счётчик «Идей» на главной — число записей с тегом «идея», без отдельной линии XP."
      />
