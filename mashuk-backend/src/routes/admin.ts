...
router.post('/shifts/:id/publish', requireAdminRole('settings'), wrap(shiftsCtrl.publishAdminShift));
router.post('/shifts/:id/unpublish', requireAdminRole('settings'), wrap(shiftsCtrl.unpublishAdminShift));
router.post('/shifts/:id/deactivate', requireAdminRole('settings'), wrap(shiftsCtrl.deactivateAdminShift));
...
router.post('/questions/realign-touchpoint-windows', requireAdminRole('settings'), wrap(admin.realignTouchpointWindows));
...
router.get('/exports/participants-archive', P('exports', 'export'), wrap(exportsCtrl.exportParticipantsArchiveHandler));
...
router.get('/exports/shift-summary.pdf', P('exports', 'export'), wrap(exportsCtrl.exportShiftSummaryPdfHandler));
router.get('/exports/meta', P('exports', 'export'), wrap(exportCustomCtrl.getExportMetaHandler));
router.post('/exports/custom', P('exports', 'export'), wrap(exportCustomCtrl.postCustomExportHandler));
router.post('/exports/jobs', P('exports', 'export'), wrap(exportCustomCtrl.postExportJobHandler));
router.post('/exports/history/preset', P('exports', 'export'), wrap(exportCustomCtrl.postPresetExportHistoryHandler));
router.get('/exports/history', P('exports', 'export'), wrap(exportCustomCtrl.getExportHistoryHandler));
router.get('/exports/history/:id', P('exports', 'export'), wrap(exportCustomCtrl.getExportHistoryItemHandler));
router.get('/exports/history/:id/download', P('exports', 'export'), wrap(exportCustomCtrl.downloadExportHistoryHandler));
...
router.get('/analytics/hub/exchange', P('analytics', 'read'), wrap(hubCtrl.getHubExchangeHandler));
router.get('/analytics/hub/stats', P('analytics', 'read'), wrap(hubCtrl.getHubStatsHandler));
router.get('/analytics/hub/direction', P('analytics', 'read'), wrap(hubCtrl.getHubDirectionHandler));
...
router.post('/piggybank-entries/bulk-delete', P('piggybank', 'delete'), wrap(piggyAdmin.bulkDeletePiggybankEntries));
...
router.get('/participants/:id/pdf-text', P('exports', 'export'), wrap(ops.buildParticipantPdfText));
router.get('/participants/:id/pdf', P('exports', 'export'), wrap(p0.buildParticipantPdf));
router.get('/participants/:id/pdf-preview', P('exports', 'export'), wrap(profilePdf.previewAdminParticipantPdf));
router.get('/participants/:id/pdf-draft', P('exports', 'export'), wrap(profilePdf.getAdminParticipantPdfDraft));
router.patch('/participants/:id/pdf-draft', P('exports', 'export'), wrap(profilePdf.patchAdminParticipantPdfDraft));
router.post('/participants/:id/pdf-publish', P('exports', 'export'), wrap(profilePdf.publishAdminParticipantPdf));
...
router.get('/integrations/delayed-survey/status', P('exports', 'export'), wrap(ops.delayedSurveyStatus));
router.post('/exports/delayed-survey/schedule', P('exports', 'export'), wrap(ops.scheduleDelayedSurvey));
