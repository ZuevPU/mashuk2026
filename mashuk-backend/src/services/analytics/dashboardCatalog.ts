...
export const DASHBOARD_CATALOG: DashboardCatalogEntry[] = [
  ...
  { id: 'after-blocks', label: '4. После блоков', minForumDay: 1, availabilityTier: 'D1', path: '/analytics/dashboards/after-blocks', kind: 'api' },
  { id: 'state-checks', label: '5. Проверка состояния', minForumDay: 1, availabilityTier: 'D1', path: '/analytics/dashboards/state-checks', kind: 'api' },
